...
public class EntityTypeTagListScreen extends Screen {
    private final Screen parent;
    private final Consumer<String> callback;
    private ScrollableSelectionList list;
    private EditBox searchField;

    public EntityTypeTagListScreen(Screen parent, Consumer<String> callback) {
        super(Component.translatable("visual_set_edit.gui.select_entity_type_tag"));
        this.parent = parent;
    ...
    private void updateList(String filter) {
        ...
        Objects.requireNonNull(ForgeRegistries.ENTITY_TYPES.tags()).getTagNames()
