...
public class StructureListScreen extends Screen {
    ...
    public StructureListScreen(Screen parent, Consumer<ResourceLocation> callback) {
        super(Component.translatable("visual_set_edit.gui.select_structure"));
        this.parent = parent;
    ...
    private void updateList(String filter) {
        ...
        if (cached.isEmpty() && !requested) {
            RegistryListHelper.requestIfNeeded("structure");
            requested = true;
        }
        ...
        cached.stream()
                ...
                .forEach(loc -> {
                    ...
                    String translationKey = "visual_set_edit.structure." + loc.getNamespace() + "." + loc.getPath();
